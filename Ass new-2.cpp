...
void initMatrices() {
	...
	vec2 viewportPosition = { 250, winHeight / 2 - viewportSize.y / 2 };
...
void drawFaces() {
	...
	mat4 M = w2v * projection * trans * rotation;
	...
	for (int idx = 0; idx < 4; idx++) {
		...
		if (orthogonalMode) {
			...
			vec4 rotatedPoint = trans * rotation * facePointH;
...
void dimondFaces() {
	...
	mat4 M = wt * projection * trans * rotation;
